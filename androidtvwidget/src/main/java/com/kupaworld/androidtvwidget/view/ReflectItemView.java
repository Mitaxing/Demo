package com.kupaworld.androidtvwidget.view;
...
import com.kupaworld.androidtvwidget.cache.BitmapMemoryCache;
import com.kupaworld.androidtvwidget.utils.DrawUtils;
import com.kupaworld.androidtvwidget.utils.Utils;
...
public class ReflectItemView extends FrameLayout {
    ...
    private void initRefPaint() {
        if (mRefPaint == null) {
            ...
            // 倒影渐变.
            mRefPaint.setShader(
                    new LinearGradient(0, 0, 0, mRefHeight, new int[]{0x77000000, 0x66AAAAAA,
                            0x0500000, 0x00000000},
