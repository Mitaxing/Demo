package com.kupaworld.androidtv.percent;
...
public class PercentLayoutHelper
{
    ...
    private void invokeMethod(String methodName, int widthHint, int heightHint, View view, @SuppressWarnings("rawtypes") Class clazz, PercentLayoutInfo.PercentVal percentVal) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException
    {
        if (Log.isLoggable(TAG, Log.DEBUG))
