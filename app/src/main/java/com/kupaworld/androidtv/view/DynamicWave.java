...
import com.kupaworld.androidtv.util.UiUtils;
...
public class DynamicWave extends View {
    ...
    // 波纹颜色
    private static final int WAVE_PAINT_COLOR = 0xff5986d7;
    // y = Asin(wx+b)+h
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 绘制第一条水波纹
            canvas.drawLine(mTotalHeight - mResetOneYPositions[i] + PROGRESS, i,
                    -mTotalHeight, i,
                    mWavePaint);

            // 绘制第二条水波纹
            canvas.drawLine(mTotalHeight - mResetTwoYPositions[i] + PROGRESS, i,
                    -mTotalHeight, i,
                    mWavePaint);
        }
