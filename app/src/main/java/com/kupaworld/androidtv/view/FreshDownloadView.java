...
public class FreshDownloadView extends View {
    ...
    private void parseAttrs(TypedArray array) {
        if (array != null) {
            try {
                setRadius(array.getDimension(R.styleable.FreshDownloadView_circular_radius, getResources().getDimension(R.dimen.w_60)));
                ...
                setCircularWidth(array.getDimension(R.styleable.FreshDownloadView_circular_width, getResources().getDimension(R.dimen.w_10)));
                setProgressTextSize(array.getDimension(R.styleable.FreshDownloadView_progress_text_size, getResources().getDimension(R.dimen.w_45)));
            } finally {
                array.recycle();
            }
        }
    ...
    private void drawText(Canvas canvas, float progress_degree) {
        ...
        publicPaint.setTextSize((float) (getProgressTextSize() / 1.5));
